...
public class ProductController {
    ...
    public ResponseEntity getAllProductsByCategoryAndPrice(@PathVariable("category") Category category, @PathVariable("price") int price){
        ...
        List<ProductResponseDto> productRequestDtos = productService.getAllProductsByCategoryAndPrice(category,price);
        return new ResponseEntity(productRequestDtos,HttpStatus.FOUND);
